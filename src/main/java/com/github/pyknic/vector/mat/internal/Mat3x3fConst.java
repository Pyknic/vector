...
/**
 * Immutable implementation of the {@link Mat3x3f}-interface.
 * 
 * @author Emil Forslund
 * @since  1.0.1
 */
public final class Mat3x3fConst extends AbstractMat3x3f {
    
    private final float el0_0, el0_1, el0_2,
                        el1_0, el1_1, el1_2,
                        el2_0, el2_1, el2_2;

    public Mat3x3fConst(float e0_0, float e0_1, float e0_2, 
    ...
    public Mat3x3fConst(Mat3x3f prototype) {
