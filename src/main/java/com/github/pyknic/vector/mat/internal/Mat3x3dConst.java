...
/**
 * Immutable implementation of the {@link Mat3x3d}-interface.
 * 
 * @author Emil Forslund
 * @since  1.1.0
 */
public final class Mat3x3dConst extends AbstractMat3x3d {
    
    private final double el0_0, el0_1, el0_2,
                        el1_0, el1_1, el1_2,
                        el2_0, el2_1, el2_2;

    public Mat3x3dConst(double e0_0, double e0_1, double e0_2, 
    ...
    public Mat3x3dConst(Mat3x3d prototype) {
