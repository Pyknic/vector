...
/**
 * Immutable implementation of the {@link Mat3x3i}-interface.
 * 
 * @author Emil Forslund
 * @since  1.1.0
 */
public final class Mat3x3iConst extends AbstractMat3x3i {
    
    private final int el0_0, el0_1, el0_2,
                        el1_0, el1_1, el1_2,
                        el2_0, el2_1, el2_2;

    public Mat3x3iConst(int e0_0, int e0_1, int e0_2, 
    ...
    public Mat3x3iConst(Mat3x3i prototype) {
