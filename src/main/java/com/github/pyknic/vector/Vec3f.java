 ...
 * @since  1.0.0
 */
public interface Vec3f extends Vecf<Vec3f> {

    Vec3f X     = constant( 1f,  0f,  0f),
          Y     = constant( 0f,  1f,  0f),
          Z     = constant( 0f,  0f,  1f),
          NEG_X = constant(-1f,  0f,  0f),
          NEG_Y = constant( 0f, -1f,  0f),
          NEG_Z = constant( 0f,  0f, -1f),
          ZERO  = constant( 0f,  0f,  0f);
     ...
     * @return           the copy
     */
    static Vec3f copy(Vec3f prototype) {
        return new Vec3fImpl(prototype);
    }
     ...
     */
    static Vec3f constant(float x, float y, float z) {
