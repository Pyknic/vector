...
import com.github.pyknic.vector.vec.Veci;
import com.github.pyknic.vector.vec.internal.Vec2iConst;
import com.github.pyknic.vector.vec.internal.Vec2iImpl;
 ...
 * @since  1.0.0
 */
public interface Vec2i extends Veci<Vec2i> {

    Vec2i X     = constant( 1,  0),
          Y     = constant( 0,  1),
          NEG_X = constant(-1,  0),
          NEG_Y = constant( 0, -1),
          ZERO  = constant( 0,  0);
     ...
     * @return           the copy
     */
    static Vec2i copy(Vec2i prototype) {
        return new Vec2iImpl(prototype);
    }
     ...
     */
    static Vec2i constant(int x, int y) {
