...
import com.github.pyknic.vector.Vec4d;
 ...
 * @since  1.0.0
 */
public final class Vec4dImpl extends AbstractVec4d {
    
    private double x, y, z, w;
    
    public Vec4dImpl(double x, double y, double z, double w) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.w = w;
    ...
    public Vec4dImpl(Vec4d prototype) {
