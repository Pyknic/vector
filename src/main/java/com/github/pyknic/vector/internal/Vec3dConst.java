...
import com.github.pyknic.vector.Vec3d;
 ...
 * @since  1.0.0
 */
public final class Vec3dConst extends AbstractVec3d {
    
    private final double x, y, z;
    
    public Vec3dConst(double x, double y, double z) {
        this.x = x;
        this.y = y;
        this.z = z;
    }
    
    public Vec3dConst(Vec3d prototype) {
