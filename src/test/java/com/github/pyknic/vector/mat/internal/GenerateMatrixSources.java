...
public final class GenerateMatrixSources {
    ...
    private final static Config[] CONFIGS = {
        new Config("i", "int", "Integer", "Int", "", "", "", "%d", "(double)", "(int)"),
        new Config("d", "double", "Double", "Double", "d", "Float.floatToIntBits((float) ", ")", "%.3f", "", "")
    };
    ...
    private final static class Config {
        ...
        private final String castToDouble;
        private final String castToFloat;
        ...
        public Config(
            ...
            this.format       = format;
            this.castToDouble = castToDouble;
